...
const slides = [
  {
    id: 1,
    bg: "url('https://picsum.photos/id/1015/1600/1000')",
    title: "Edge Visuals",
  ...
  {
    id: 2,
    bg: "url('https://picsum.photos/id/1011/1600/1000')",
  ...
  {
    id: 3,
    bg: "url('https://picsum.photos/id/1018/1600/1000')",
    title: "Brand Motion",
  ...
  {
    id: 4,
    bg: "url('https://picsum.photos/id/1021/1600/1000')",
    title: "E-commerce UX",
  ...
  {
    id: 5,
    bg: "url('https://picsum.photos/id/1005/1600/1000')",
...
export default function MzaCarousel() {
  ...
  useEffect(() => {
    ...
    const instance = new MzaCarouselClass(root, { transitionMs: 900 });
      ...
      <div className="mzaCarousel-viewport" tabIndex="0">
        <div className="mzaCarousel-track">
          {slides.map((slide, index) => (
            ...
            >
              <div className="mzaCard" style={{ "--mzaCard-bg": slide.bg }}>
                ...
                <footer className="mzaCard-actions mzaPar-3">
                  <button className="mzaBtn">{slide.btn}</button>
                </footer>
              </div>
            </article>
          ))}
